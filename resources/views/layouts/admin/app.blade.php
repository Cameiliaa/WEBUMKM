...
<head>
    ...
    <title>Jajanan Rakyat | @yield('title')</title>
...
<body class="hold-transition sidebar-mini layout-fixed">
    <div class="wrapper">
        ...
        <!-- Navbar -->
        <nav class="main-header navbar navbar-expand fixed-top" style="background: linear-gradient(135deg, #ff0000 0%, #ffffff 50%, #000000 100%)">
            <!-- Left navbar links -->
            <ul class="navbar-nav">
                <li class="nav-item">
        ...
        <aside class="main-sidebar elevation-4" style="background: black;">
            ...
            <a href="#" class="brand-link text-center">
                <div style="color: #ffffff; font-family: 'Roboto', sans-serif">
                    <div class="fw-bold" style="font-size: 20px">Jajanan Rakyat</div>
                </div>
            </a>
